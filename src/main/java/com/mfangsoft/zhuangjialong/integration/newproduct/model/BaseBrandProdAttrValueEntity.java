...
/**
 *   品牌产品属性值表
 * table t_biz_brand_prod_attrvalue
 *
 * @MLTH_generated do_not_delete_during_merge
 */
public class BaseBrandProdAttrValueEntity implements Serializable {
    /**
     * column id
     *
     * @MLTH_generated
     ...
     * This field corresponds to the database table t_biz_brand_prod_attrvalue
     *
     * @MLTH_generated
     */
