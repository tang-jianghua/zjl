package com.mfangsoft.zhuangjialong.app.sendsms.service.impl;
...
public class SendSMSServiceImpl implements SendSMSService{
	...
	public  boolean sendSMS(String phone,String message,String message_suf) {
		//连接超时及读取超时设置
				...
				String apikey = "ce7161ab3c791cf254906096184b5f7f";  //apikey秘钥（请登录 http://m.5c.com.cn 短信平台-->账号管理-->我的信息 中复制apikey）
