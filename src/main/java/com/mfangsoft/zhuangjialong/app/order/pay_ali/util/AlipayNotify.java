package com.mfangsoft.zhuangjialong.app.order.pay_ali.util;
...
//        String sWord = "responseTxt=" + responseTxt + "\n isSign=" + isSign + "\n 返回回来的参数：" + AlipayCore.createLinkStringForVerify(params);
...
//        System.out.println(sWord);
	...
	private static boolean getSignVeryfy(Map<String, String> Params, String sign) {
        ...
        //获取待签名字符串
        String preSignStr = AlipayCore.createLinkStringForVerify(sParaNew);
        //获得签名验证结果
