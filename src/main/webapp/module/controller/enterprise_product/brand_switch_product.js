App.controller("entbrandSwitchProductCtrl",function($scope, $rootScope, $location, $http, $compile,path,$routeParams) {
...
$scope.mainGridOptions = {
	dataSource : {
			transport : {
				read : {
					url : path+"/server/ent/saleattrlist",
					type : 'POST',
					dataType : "json",
...
$scope.productTileInformation=function(){
