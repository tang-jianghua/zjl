App.controller("brandWallperProductCtrl",function($scope, $rootScope, $location, $http, $compile,path,$routeParams) {
...
$scope.mainGridOptions = {
	dataSource : {
			transport : {
				read : {
					url : path+"/server/brand/wallpaperlist",
					type : 'POST',
					dataType : "json",
	...
	columns : [
			...
			template:function(e){
	    		...
	    		if(params.method=="check"){
	    			...
	    			template_html='<div class="operation k-state-default" ng-click="edit(\''+e.product_id+'\')">编辑</div>';
	    		}
