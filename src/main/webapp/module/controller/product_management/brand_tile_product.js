App.controller("brandTileProductCtrl",function($scope, $rootScope, $location, $http, $compile,path,$routeParams) {
...
$scope.mainGridOptions = {
	dataSource : {
			transport : {
				read : {
					url : path+"/server/brand/tilelist",
					type : 'POST',
					dataType : "json",
	...
	columns : [
			...
			{ 
				...
				template:function(e){
		    		...
		    		/*+'<div class="k-button k-state-default" ng-click="copyUrl(\''+e.id+'\')">复制链接</div>';*/
