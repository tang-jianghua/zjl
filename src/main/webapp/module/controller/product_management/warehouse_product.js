App.controller("warehouseProduct",function($scope, $rootScope, $location, $http, $compile,path) {
	$scope.form={};
	var num=0;
...
$scope.getCurrentUserInfo = function(){
	$http({
		...
		num=data.enterpriseEntity.class_id;
		var comm;
		/*"/server/ent/wallpaperlist" 壁纸
		"/server/ent/tilelist"  瓷砖
		/server/ent/saleattrlist" 开关
		"/server/ent/floorlist" 地板
		"/server/ent/doorlist" 门
		"/server/ent/paintlist" 涂料*/
